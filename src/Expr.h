...
using Expr = std::variant<BinaryExprPtr,GroupingExprPtr,LiteralValPtr,UnaryExprPtr>;

template <typename V, typename Out>
concept ExprVisitor = requires (V v, const BinaryExprPtr& arg_0, const GroupingExprPtr& arg_1, const LiteralValPtr& arg_2, const UnaryExprPtr& arg_3) { 
